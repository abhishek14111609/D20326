<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo mt-5 mb-5 d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('admin.dashboard') }}" class="app-brand-link d-flex flex-column align-items-center w-100">
            <span class="app-brand-logo demo">
                <img src="https://duos.webvibeinfotech.in/public/assets/img/favicon/only_logo1.png" alt="Logo"
                    style="height: 100px;">
            </span>
        ...
        <a href="javascript:void(0);"
            class="layout-menu-toggle menu-link text-large ms-auto position-absolute end-0 me-3">
    ...
    <ul class="menu-inner py-1">
      ...
      <a href="{{ route('admin.chats.index') }}" class="menu-link">
        ...
        <li
            class="menu-item {{ request()->is('admin/challenges*') || request()->is('admin/competitions*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                <li
                    class="menu-item {{ request()->is('admin/challenges') || request()->is('admin/challenges/index') ? 'active' : '' }}">
                ...
                @if ($defaultCompetition)
                    <li class="menu-item {{ request()->routeIs('admin.competitions.quizzes.*') ? 'active' : '' }}">
                        <a href="{{ route('admin.competitions.quizzes.index', ['competition' => $defaultCompetition->id]) }}"
                            class="menu-link">
