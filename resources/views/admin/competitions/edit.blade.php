...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <form id="competition-edit-form" action="{{ route('admin.competitions.update', $competition) }}" method="POST"
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <button type="submit" form="competition-edit-form"
                                    onclick="document.getElementById('competition-edit-form').submit(); return false;"
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs mb-4" id="competitionTabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="schedule-tab" data-bs-toggle="tab" href="#schedule"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="prizes-tab" data-bs-toggle="tab" href="#prizes" role="tab"
                                        aria-controls="prizes" aria-selected="false">
                            ...
                            <div class="tab-content" id="competitionTabsContent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @php
                                                    $tags = is_array($competition->tags)
                                                        ? $competition->tags
                                                        : (is_string($competition->tags)
                                                            ? json_decode($competition->tags, true)
                                                            : []);
                                        ...
                                        <div class="col-md-4">
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body text-center">
                                                    <div class="mb-3">
                                                        <img src="{{ $competition->image ? 'https://duos.webvibeinfotech.in/storage/app/public/' . $competition->image : '#' }}"
                                                            id="image-preview"
                                                            class="img-fluid rounded mb-2 {{ $competition->image ? '' : 'd-none' }}"
                                                            style="max-height: 200px;">
                                                        <input type="file"
                                                            class="form-control @error('image') is-invalid @enderror"
                                                            id="image" name="image" accept="image/*"
                                                            onchange="previewImage(this)">
                                                        <small class="text-muted d-block mt-2">Recommended size: 800x450px
                                                            (16:9 aspect ratio)</small>
                                                        @error('image')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body text-center">
                                                    <div class="mb-3">
                                                        <img src="{{ $competition->banner_image ? 'https://duos.webvibeinfotech.in/storage/app/public/' . $competition->banner_image : '#' }}"
                                                            id="banner-preview"
                                                            class="img-fluid rounded mb-2 {{ $competition->banner_image ? '' : 'd-none' }}"
                                                            style="max-height: 200px;">
                                                        <input type="file"
                                                            class="form-control @error('banner_image') is-invalid @enderror"
                                                            id="banner_image" name="banner_image" accept="image/*"
                                                            onchange="previewBanner(this)">
                                                        <small class="text-muted d-block mt-2">Recommended size:
                                                            1200x400px</small>
                                                        @error('banner_image')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="card-body">
                                                    <div class="form-check form-switch mb-3">
                                                        ...
                                                        <label class="form-check-label" for="is_featured">Featured
                                                            Competition</label>
                                                        <small class="text-muted d-block">Featured competitions will be
                                                            highlighted on the competitions page</small>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="schedule" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="registration_start">Registration Start
                                                    <span class="text-danger">*</span></label>
                                                <input type="datetime-local"
                                                    class="form-control flatpickr-datetime @error('registration_start') is-invalid @enderror"
                                                    id="registration_start" name="registration_start"
                                                    value="{{ old('registration_start', $competition->registration_start ? $competition->registration_start->format('Y-m-d\TH:i') : '') }}"
                                                    required>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="registration_end">Registration End <span
                                                        class="text-danger">*</span></label>
                                                <input type="datetime-local"
                                                    class="form-control flatpickr-datetime @error('registration_end') is-invalid @enderror"
                                                    id="registration_end" name="registration_end"
                                                    value="{{ old('registration_end', $competition->registration_end ? $competition->registration_end->format('Y-m-d\TH:i') : '') }}"
                                                    required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="competition_start">Competition Start <span
                                                        class="text-danger">*</span></label>
                                                <input type="datetime-local"
                                                    class="form-control flatpickr-datetime @error('competition_start') is-invalid @enderror"
                                                    id="competition_start" name="competition_start"
                                                    value="{{ old('competition_start', $competition->competition_start ? $competition->competition_start->format('Y-m-d\TH:i') : '') }}"
                                                    required>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="competition_end">Competition End <span
                                                        class="text-danger">*</span></label>
                                                <input type="datetime-local"
                                                    class="form-control flatpickr-datetime @error('competition_end') is-invalid @enderror"
                                                    id="competition_end" name="competition_end"
                                                    value="{{ old('competition_end', $competition->competition_end ? $competition->competition_end->format('Y-m-d\TH:i') : '') }}"
                                                    required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="timezone">Timezone <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select @error('timezone') is-invalid @enderror"
                                                    id="timezone" name="timezone" required>
                                                    @foreach (timezone_identifiers_list() as $timezone)
                                                        <option value="{{ $timezone }}"
                                                            {{ old('timezone', $competition->timezone) == $timezone ? 'selected' : '' }}>
                                                            {{ $timezone }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="tab-pane fade" id="details" role="tabpanel" aria-labelledby="details-tab">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="min_participants">Min Participants <span
                                                        class="text-danger">*</span></label>
                                                <input type="number"
                                                    ...
                                                    min="1" required>
                                                <small class="text-muted">Minimum number of participants required for the
                                                    competition to proceed</small>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label" for="type">Competition Type <span
                                                            class="text-danger">*</span></label>
                                                    ...
                                                    <select class="form-select @error('type') is-invalid @enderror"
                                                        ...
                                                        <option value="solo"
                                                            {{ old('type', $competition->type) == 'solo' ? 'selected' : '' }}>
                                                            Solo</option>
                                                        <option value="team"
                                                            {{ old('type', $competition->type) == 'team' ? 'selected' : '' }}>
                                                            Team</option>
                                                        <option value="tournament"
                                                            {{ old('type', $competition->type) == 'tournament' ? 'selected' : '' }}>
                                                            Tournament</option>
                                                        <option value="league"
                                                            {{ old('type', $competition->type) == 'league' ? 'selected' : '' }}>
                                                            League</option>
                                                    </select>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select @error('status') is-invalid @enderror"
                                                        ...
                                                        <option value="draft"
                                                            {{ old('status', $competition->status) == 'draft' ? 'selected' : '' }}>
                                                            Draft</option>
                                                        <option value="upcoming"
                                                            {{ old('status', $competition->status) == 'upcoming' ? 'selected' : '' }}>
                                                            Upcoming</option>
                                                        <option value="active"
                                                            {{ old('status', $competition->status) == 'active' ? 'selected' : '' }}>
                                                            Active</option>
                                                        <option value="completed"
                                                            {{ old('status', $competition->status) == 'completed' ? 'selected' : '' }}>
                                                            Completed</option>
                                                        <option value="cancelled"
                                                            {{ old('status', $competition->status) == 'cancelled' ? 'selected' : '' }}>
                                                            Cancelled</option>
                                                    </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('currency') is-invalid @enderror"
                                                    ...
                                                    <option value="USD"
                                                        {{ old('currency', $competition->currency) == 'USD' ? 'selected' : '' }}>
                                                        USD ($)</option>
                                                    <option value="EUR"
                                                        {{ old('currency', $competition->currency) == 'EUR' ? 'selected' : '' }}>
                                                        EUR (€)</option>
                                                    <option value="GBP"
                                                        {{ old('currency', $competition->currency) == 'GBP' ? 'selected' : '' }}>
                                                        GBP (£)</option>
                                                    <option value="JPY"
                                                        {{ old('currency', $competition->currency) == 'JPY' ? 'selected' : '' }}>
                                                        JPY (¥)</option>
                                                    <option value="AUD"
                                                        {{ old('currency', $competition->currency) == 'AUD' ? 'selected' : '' }}>
                                                        AUD ($)</option>
                                                    <option value="CAD"
                                                        {{ old('currency', $competition->currency) == 'CAD' ? 'selected' : '' }}>
                                                        CAD ($)</option>
                                                </select>
                                                @error('currency')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="is_private"
                                                    ...
                                                    {{ old('is_private', $competition->is_private) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_private">Private
                                                    Competition</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="prize_distribution">Prize
                                                    Distribution</label>
                                ...
                                <div class="tab-pane fade" id="prizes" role="tabpanel" aria-labelledby="prizes-tab">
                                    <div class="alert alert-info">
                                        ...
                                        Add the prize tiers for this competition. You can add multiple prize tiers with
                                        different ranks and rewards.
                                    </div>

                                    <div id="prize-tiers-container">
                                        @php
                                            $prizes = old('prizes')
                                                ? json_decode(old('prizes'), true)
                                                : ($competition->prizes
                                                    ? json_decode($competition->prizes, true)
                                                    : []);
                                        @endphp
                                        ...
                                        @if (count($prizes) > 0)
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-1 d-flex align-items-center">
                                                                <span
                                                                    class="badge bg-primary rank-badge">{{ $index + 1 }}</span>
                                                                <input type="hidden"
                                                                    name="prizes[{{ $index }}][rank]"
                                                                    value="{{ $index + 1 }}">
                                                            </div>
                                                            <div class="col-md-5">
                                                                <label class="form-label">Prize Name <span
                                                                        class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label class="form-label">Prize Value <span
                                                                        class="text-danger">*</span></label>
                                                                <div class="input-group">
                                                                    <span
                                                                        class="input-group-text">{{ $competition->currency ?? 'USD' }}</span>
                                                            ...
                                                            <div class="col-md-2 d-flex align-items-end">
                                                                <button type="button"
                                                                    class="btn btn-danger btn-sm remove-prize-tier"
                                                                    data-index="{{ $index }}">
                                            ...
                                            @endforeach
                                        @else
                                            <p class="text-muted">No prize tiers added yet. Click the button below to add
                                                one.</p>
                                        @endif
                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-1 d-flex align-items-center">
                                                        ...
                                                        <input type="hidden" name="prizes[__INDEX__][rank]"
                                                            value="__RANK__">
                                                    </div>
                                                    <div class="col-md-5">
                                                        <label class="form-label">Prize Name <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                            name="prizes[__INDEX__][name]" required>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label class="form-label">Prize Value <span
                                                                class="text-danger">*</span></label>
                                                        <div class="input-group">
                                                            <span
                                                                class="input-group-text">{{ $competition->currency ?? 'USD' }}</span>
                                                            <input type="number" class="form-control"
                                                                name="prizes[__INDEX__][value]" min="0"
                                                                step="0.01" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 d-flex align-items-end">
                                    ...
                                    <input type="hidden" name="prizes" id="prizes-json"
                                        value="{{ old('prizes', $competition->prizes) }}">
                                </div>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (document.querySelector('.flatpickr-datetime')) {
                        ...
                        if (registrationStart) {
                            ...
                            const prizeDistributionContent = document.getElementById('prize-distribution-editor').innerHTML
                                .trim();
