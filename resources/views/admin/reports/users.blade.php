        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="growthDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
new Chart(typeCtx, {
    ...
    data: {
        ...
        datasets: [{
            data: [{{ $reports['total_users'] - $reports['premium_users'] }}, {{ $reports['premium_users'] }}],
