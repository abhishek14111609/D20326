...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="https://duos.webvibeinfotech.in/public/assets/img/favicon/only_logo1.png" />
	...
	<style>
  body {
    background: linear-gradient(135deg, #eef2ff, #f8fafc); /* pachad no design */
    min-height: 100vh;
    display: flex;
    align-items: center;
  ...
  .custom-card {
    width: 700px;
    max-width: 720px;        /* card ni width */
    /* margin: 20px;            /* bey baju equal jagiya */
    border-radius: 20px;     /* bey baju khuna smooth */
    overflow: hidden;        /* background bahar na jaye */
...
.authentication-wrapper.authentication-basic .authentication-inner::before {
    position: absolute;
    background: 
 color-mix(in sRGB, var(--bs-primary) 60%, var(--bs-paper-bg));
    block-size: 148px;
    content: " ";
    inline-size: 148px;
...
<div class="container-xxl">
  <div class="authentication-wrapper authentication-basic ">
    <div class="authentication-inner" style="margin-left:-200px;">
      <!-- Login -->
  ...
  <div class="card-body">
    ...
    <div class="app-brand justify-content-center">
      <a href="#" class="app-brand-link gap-2">
        <span class="app-brand-logo" style="margin-top:-30px;">
          <img src="https://duos.webvibeinfotech.in/public/assets/img/favicon/only_logo1.png"
               alt="Logo"
               style="height: 200px;">
        </span><br>
      </a>
    ...
    <br><br><h4 class="mb-2 text-center" style="margin-top:-40px;">
      Welcome to Duos! 👋
    </h4>

    <p style="margin-top:5%;">We’re here to help. If you have any questions, feedback, or need assistance, feel free to reach out to us.</p>

    <p class="mb-4"><b>NAME :</b> Kambily Traore</p>
    <p class="mb-4"><b>Email :</b> Traorekambily@gmail.com</p>

    <p class="mb-4">We will get back to you as soon as possible.</p>
